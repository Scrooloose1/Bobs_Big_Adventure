...
void CMasterModelCreator::LoadMediaFolders()
{
	...
	myEngine->AddMediaFolder(".\\media\\Backgrounds");
	myEngine->AddMediaFolder(".\\media\\Bob");
	myEngine->AddMediaFolder(".\\media\\Collectable_Items");
	myEngine->AddMediaFolder(".\\media\\Doors");
	myEngine->AddMediaFolder(".\\media\\Explosions");
	myEngine->AddMediaFolder(".\\media\\Floors");
	myEngine->AddMediaFolder(".\\media\\Models");
	myEngine->AddMediaFolder(".\\media\\Particles");
	myEngine->AddMediaFolder(".\\media\\User_Interface");
	myEngine->AddMediaFolder(".\\media\\Walls");
	myEngine->AddMediaFolder(".\\media\\Zombies");
	myEngine->AddMediaFolder(".\\media\\Other");
